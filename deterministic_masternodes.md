...
Open a text editor such as notepad to prepare this command. Replace each argument to the command as follows:
    ...
    * votingKeyAddr: The new Thought address generated above, or the address of a delegate, used for proposal voting [[Important, this address needs to be the same as ownerKeyAddr above]]
